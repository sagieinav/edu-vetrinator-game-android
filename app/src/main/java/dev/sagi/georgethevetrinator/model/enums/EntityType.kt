...
enum class EntityType(val drawableResourceId: Int, val crashMsgResourceId: Int) {
    EIGHT_OF_CLUBS(
        R.drawable.img_obstacle_eight_clubs,
        R.string.obstacle_eight_crash_msg),
    POCKET_KINGS(
        R.drawable.img_obstacle_pocket_kings,
        R.string.obstacle_kings_crash_msg),
    NETA(
        R.drawable.img_obstacle_neta,
        R.string.obstacle_neta_crash_msg),
    ANNOYING_KID(
        R.drawable.img_obstacle_kid,
        R.string.obstacle_kid_crash_msg),
    CRASHED(
        R.drawable.img_obstacle_crashed,
        R.string.obstacle_fallback_crash_msg),

    COIN(
        R.drawable.img_reward_coin,
        R.string.reward_coin_collide_msg),

    COLLECTED(
        R.drawable.img_reward_coin_collected,
        R.string.reward_coin_collide_msg);
